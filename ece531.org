...
:IMPORTANT: Add code at bottom of hw.c to capture _*NON-OPTION ARGUMENTS*_ and
pass them to _*message pointer*_ !!!!
:IMPORTANT: Only after adding and testing _message pointer_ , attempt the debugging below!!
